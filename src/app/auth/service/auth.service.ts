...
export class AuthService {
  ...
  getMovies() {
    return this.http.get(`${this.url}discover/movie?api_key=${this.apiKey}&sort_by=popularity.desc`);
  }
  
  getFavoriteList() {
    return this.http.get(`${this.url}list/${this.list_id}?api_key=${this.apiKey}&language=en-US`)
  }
